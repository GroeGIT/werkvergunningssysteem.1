...
class MeasuresControllerTest < ActionController::TestCase
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post :create, measure: { enquirymeasure_id: @measure.enquirymeasure_id, measurement: @measure.measurement, type: @measure.type }
    end
  ...
  test "should update measure" do
    patch :update, id: @measure, measure: { enquirymeasure_id: @measure.enquirymeasure_id, measurement: @measure.measurement, type: @measure.type }
    assert_redirected_to measure_path(assigns(:measure))
  end
